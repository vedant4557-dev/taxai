// TaxSmart — app.js (combined bundle)
// All modules concatenated in dependency order
// Generated: removes ES module scope isolation issues
...
function stickyPrimaryAction(){
  ...
  if(bal < -1000){
    open('https://onlineservices.tin.egov-nsdl.com/etaxnew/tdsnontds.jsp','_blank');
  } else {
    open('https://www.incometax.gov.in/iec/foportal','_blank');
  }
...
function sendCAWhatsApp(){
  ...
  open('https://wa.me/?text='+encodeURIComponent(intro+window._caBriefText.substring(0,800)+footer), '_blank');
...
function shareWithSelf(){
  ...
  open('mailto:?subject='+encodeURIComponent(subject)+'&body='+encodeURIComponent(body));
...
// ══════════════════════════════════════════════════════════════════════════════
// openRetentionModal defined in features.js module below
...
function buildPrimaryCTA(bal, bestTax, win){
  ...
  if(bal > 1000){
    ...
    primaryAction = "open('https://www.incometax.gov.in/iec/foportal','_blank')";
    ...
    primaryAction = "open('https://onlineservices.tin.egov-nsdl.com/etaxnew/tdsnontds.jsp','_blank')";
...
<\x73cript>window.onload=()=>{setTimeout(()=>print(),400)}<\/script>
</body></html>`;
...
function shareTaxCardLinkedIn() {
  ...
  open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(url)}&summary=${encodeURIComponent(text)}`, '_blank');
...
(function(){
  ...
  addEventListener('scroll',closeActive,true);
  addEventListener('resize',closeActive);
})();
